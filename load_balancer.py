...
class SimpleSwitch13(app_manager.RyuApp):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.virtual_lb_ip = "10.0.0.42"                                               #Virtual Load Balancer IP
        ...
        self.serverlist.append({'ip':"10.0.0.4", 'mac':"00:00:00:00:00:04", "outport":"1"})            #Appending all given IP's, assumed MAC's and ports of switch to which servers are connected to the list created 
    ...
    def _packet_in_handler(self, ev):
        ...
        count = self.counter % 2                           #Round robin fashion setup
